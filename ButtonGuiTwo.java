...
public class ButtonGuiTwo extends JFrame
{
    ...
    {
        mainFrame = new JFrame("Example (2) of a GUI with a button");
    ...
    {
        new ButtonGuiTwo(); //automatically calls the constructor
...
/*
"C:\Program Files\Java\jdk-25.0.2\bin\java.exe" "-javaagent:C:\Program Files\JetBrains\IntelliJ IDEA 2025.3.1\lib\idea_rt.jar=65021" -Dfile.encoding=UTF-8 -Dsun.stdout.encoding=UTF-8 -Dsun.stderr.encoding=UTF-8 -classpath "C:\Users\joann\Desktop\CSIS24-JAVA I\W9 GUI and Eclipse IDE\ButtonGuiTwo\out\production\ButtonGuiTwo" ButtonGuiTwo
